...
employee_list = [
   ...
   {"id": 12483, "name": "Ryan", "department": "Inventory Manager"},
...
def to_mod_list(employee_list):
   ...
   # First way ti create: returns a list object
   map_employee = map(mod, employee_list)
   return [x for x in map_employee]

  # Second way to create: returns a list
   # map_employee = map(mod, employee_list)
...
def generate_usernames(mod_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   return [employee_name.replace(" ", "_") for employee_name in mod_list]
